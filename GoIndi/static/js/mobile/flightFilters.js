...
function flightFilters(){
	var routeOptions =""
		for (var k =0;k<flightRouteList.length;k++){
			...
			var routeOption="<a href='#pagetwo'data-transition='slide' id='"+route+"' route='"+flightRouteList[k]+"' class='list-group-item list-group-item-warning flightRouteMenu'  data-parent='#RouteMenu' >"+routeContent+"</a>"
