function showSortMenuMain(){
	var sortMenuMain = "" + "<br/><div class='btn-group btn-group-justified' role='group' aria-label='...'><div class='btn-group' role='group'><button type='button' id='priceSort' class='btn btn-default'>Cheapest</button></div><div class='btn-group' role='group'><button type='button' id = 'durationSort' class='btn btn-default'>Fastest</button></div></div><br/>"
