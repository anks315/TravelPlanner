...
urlpatterns = patterns('',
    ...
    url(r'mainMobile$', 'GoIndi.views.mainMobile'),
    url(r'planning$', 'GoIndi.views.planning'),
    url(r'planningMobile$', 'GoIndi.views.planningMobile'),
    ...
    url(r'bus/arrangement', 'GoIndi.views.arrangement'),
