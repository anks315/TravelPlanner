...
urlpatterns = patterns('',
    ...
    url(r'direct$', 'GoIndi.views.flightdirectandnearapi'),
    url(r'biggest$', 'GoIndi.views.flightbigapi'),
    url(r'neartobig$', 'GoIndi.views.flightnearbigapi'),
    url(r'bigtonear$', 'GoIndi.views.flightbignearapi'),
